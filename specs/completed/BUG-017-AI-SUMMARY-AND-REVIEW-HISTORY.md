...
- Status: DONE（迁移前 `DONE_LOCAL / NOT_DEPLOYED`；viewport `N/A`（仅文案、无几何变化），UI current-state 已合并；生产 MySQL 只读路径正确性与部署为独立发布门禁；2026-09-12 移入 `specs/completed/`）
...
|---|---|---|---|
| `specs/completed/BUG-017-AI-SUMMARY-AND-REVIEW-HISTORY.md` | add/update | 审批、诊断、实现与验证证据 | 行为变更门禁 |
