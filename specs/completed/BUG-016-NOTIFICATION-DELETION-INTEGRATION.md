...
- Status: DONE（迁移前 VERIFYING；前端影响 no，本地全部 TP PASS、独立复核 `PASS WITH NON-BLOCKS`、current-state 已合并、灰度版本 `flask-ik19-015`；真实删除授权/发送为独立体验版门禁；2026-09-12 移入 `specs/completed/`）
