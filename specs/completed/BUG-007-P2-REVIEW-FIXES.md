...
- Status: DONE（迁移前 `IMPLEMENTED_VERIFIED_LOCALLY`；全套本地测试 PASS、独立只读复审两轮 P2 已修复关闭、current-state 已合并；真机/开发者工具三视口与真实 Ark/MySQL 为独立发布门禁；2026-09-12 移入 `specs/completed/`）
