...
- Status: `REJECTED`
- Rejected: 2026-09-12 — 未批准草案中的 `schedule_reminder` 与 `review_digest` 已由
  `FEAT-003-NOTIFICATION-CHANNEL.md` 的批准 revision 实现并接管；不得再按本草案重复实施。
- Risk: `R3`
- Spec owner: 产品负责人（用户）
- Implementer: `TBD`
...
|---|---|---|---|---|
| `specs/rejected/FEAT-003-REVIEW-AND-CLASS-REMINDERS.md` | retain as history | rejection/supersession evidence | historical task record | workflow |
