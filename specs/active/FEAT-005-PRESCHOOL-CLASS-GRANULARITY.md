...
| `F-006` | 待审批 `SPEC-20260906-DATA-CLEANUP-01` 计划把创建家庭与建孩子解耦，并从 onboarding 删除孩子/年级字段 | `specs/active/FEAT-006-DATA-CLEANUP-AND-FAMILY-RESET.md`（READY_FOR_REVIEW，未实现） |
