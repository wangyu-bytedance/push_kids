...
本轮新增 `docs/design/frontend/prototypes/DREV-20260905-UX-04/` 与本文；没有更改生产 pages。当前 UI/Feature 文档仍描述已实现版本，批准且完成原生验证后再合并新事实，避免设计提案被误认为线上状态。
...
用户本次评审对象是视觉密度、行动层级、按钮和表单，以及邀请/申请路径。未批准之前，保持生产版本不变。
