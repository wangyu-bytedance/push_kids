...
- Status: `DONE — implemented and locally verified; native DevTools smoke remains a release acceptance item`
...
| `specs/active/BUG-014-NEW-USER-FAMILY-ENTRY.md` | modify | 回填批准、验证、review 与关闭证据 | 任务事实闭环 |
