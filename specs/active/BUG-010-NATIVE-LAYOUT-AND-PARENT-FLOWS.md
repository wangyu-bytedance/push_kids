...
- Status: `VERIFYING / 390_CUA_PASSED / MATRIX_PENDING`（V3 本地实现与 390 CUA 完成，其他原生视口仍是关闭门禁）
...
- Approved Design Revision: `DREV-20260905-UX-03`；具体交互稿：`specs/active/BUG-010-INTERACTION-DESIGN-V3-DRAFT.md`。
