# UI-010 / DREV-20260831-06 approval manifest
...
- Spec: `SPEC-20260831-08`
- Prototype: `docs/design/frontend/prototypes/DREV-20260831-06/index.html`
...
- 首次进入标题由“先添加一个孩子”改为“开始记录孩子的学习”。
- 主操作由“创建孩子”改为“添加孩子”。
- 次操作按用户评审意见改为“申请加入家庭”。
- 说明采用家庭协作语言，明确家人已添加时走申请路径，审批后才能查看内容。
