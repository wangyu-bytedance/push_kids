# UI-010 / DREV-20260831-08 approval manifest
...
- Spec: `SPEC-20260831-10`
- Prototype: `docs/design/frontend/prototypes/DREV-20260831-08/index.html`
...
本轮只请求批准核心旅程和视觉方向。登录 loading/error、孩子信息表单、approved/rejected/expired/
revoked/duplicate、关系编辑和最后 manager 保护仍需补图后，才能批准完整实现门禁。

## Review changes from DREV-20260831-07

- 首次进入主操作由“添加孩子”改为“开始记录”，描述用户目标而不是后台对象操作。
- 首次进入说明改为“第一次使用，可以直接开始记录；如果家人已经在使用，请申请加入家庭”。
- 分享、申请、等待确认和管理员处理页面沿用 DREV-20260831-07 的家庭化措辞。
